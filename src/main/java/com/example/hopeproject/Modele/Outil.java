...
public class Outil {
    ...
    public Outil(String titre, String domaine, String descriptionSimple, String descriptionDetaillee, String acces, String lien) {
        this.titre = titre;
    ...
    public Outil(String titre, String domaine, String descriptionSimple, String acces) {
        this.titre = titre;
        this.domaine = domaine;
        this.descriptionSimple = descriptionSimple;
        this.acces = acces;
